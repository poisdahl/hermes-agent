...
class TestSendMessageTool:
    ...
    def test_mirror_receives_both_current_session_user_ids(self):
        ...
        with patch("gateway.config.load_gateway_config", return_value=config), \
             ...
             patch("gateway.session_context.get_session_env") as get_env, \
            ...
            get_env.side_effect = lambda name, default="": {
                ...
                "HERMES_SESSION_USER_ID": "shared",
                "HERMES_SESSION_USER_ID_ALT": "uuid-alice",
            }.get(name, default)
